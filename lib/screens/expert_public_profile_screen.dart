      ...
      builder: (context, snap) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              if (currentUserId != null && currentUserId != widget.expertId)
                StreamBuilder<bool>(
                  stream: blockRepo.watchIsBlocked(
                    currentUserId: currentUserId,
                    blockedUserId: widget.expertId,
                  ),
                    ...
                    return PopupMenuButton<String>(
                      ...
                      onSelected: (value) async {
                        if (value == 'block') {
                          ...
                          await _showReportDialog(widget.expertId, name);
                        }
                      },
                      itemBuilder: (context) => [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                StreamBuilder<int>(
                                  stream: followRepo.watchFollowingCount(expertId),
                                  builder: (context, snap) {
                                ...
                                const SizedBox(width: 16),
                                StreamBuilder<int>(
                                  stream: followRepo.watchFollowersCount(expertId),
                                  builder: (context, snap) {
                ...
                ], // ✅ Row'un children listesinin kapanışı
              ),
            ),
